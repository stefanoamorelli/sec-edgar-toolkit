...
- **[edgartools](https://github.com/dgunning/edgartools)** - The reference for ergonomic EDGAR access in Python; this toolkit's object API was originally inspired by its design
