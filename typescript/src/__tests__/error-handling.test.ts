...
describe("Error Classes", () => {
  ...
  describe("CompanyNotFoundError", () => {
    it("should include identifier and search type", () => {
      ...
      expect(error.message).toBe(
        "Company not found: AAPL (searched by ticker)",
      );
  ...
  describe("Filing Errors", () => {
    it("should create FilingNotFoundError", () => {
      const error = new FilingNotFoundError(
        "0000320193-24-000001",
        "0000320193",
      );
      expect(error.message).toBe(
        "Filing not found: 0000320193-24-000001 for CIK 0000320193",
      );
  ...
  describe("Parsing Errors", () => {
    it("should create XMLParsingError with location", () => {
      ...
      expect(error.message).toBe(
        "XML parsing error at line 10, column 25: Invalid character",
      );
  ...
  describe("XBRL Errors", () => {
    it("should create ConceptNotFoundError", () => {
      ...
      expect(error.message).toBe(
        "XBRL concept not found: CustomConcept in custom-taxonomy",
      );
